...
const chapter1 = () => {
   ...
   document.querySelector("div.content").innerHTML = ch1_text;
};

const chapter2 = () => {
   alert('load chapter 2');
   document.querySelector("div.content").innerHTML = ch2_text;
};

const chapter3 = () => {
   alert('load chapter 3');
   document.querySelector("div.content").innerHTML = ch3_text;
};
